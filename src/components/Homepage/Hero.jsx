...
const Hero = () => {
  return (
    <div className="w-full relative text-dark">
      ...
      <div className="container mx-auto space-y-[2rem]  text-center absolute top-[29rem] left-0 right-0 text-secondary ">
        <h2 className="text-[13px] font-opensans text-primary font-semibold tracking-[.4rem]">
          WELCOME TO
        </h2>
        <h3 className="text-[64px] font-futura font-semibold tracking-[.4rem]">
          MMA INSPIRE
        </h3>
        <button className="tracking-[.2rem] text-[15px] px-2 h-[64px] w-[204px] mt-4 font-opensans font-semibold bg-white text-dark relative overflow-hidden group">
