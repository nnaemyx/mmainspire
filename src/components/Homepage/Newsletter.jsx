    ...
    <div className="lg:mt-36  mt-12">
      <div className="relative">
        ...
        <div className="flex justify-center">
          <div className="bg-white md:w-[580px] w-[340px] 425:w-[360px] font-opensans md:px-8 px-6 h-[260px] md:h-[372px] absolute md:left-24 md:top-16 top-8 left-5 425:left-8 text-center">
